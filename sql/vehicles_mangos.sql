...
(29144,32633,24418,25334,25743,26191,26523,26813,27061,27258,27354,27409,27496,27587,27593,27626,27661,27692,27714,27755,27756,27838,
27839,27850,27883,27905,27996,28851,29563,29598,29602,29708,29857,29903,30021,30066,30108,30123,30124,30134,30228,30234,30248,30272,
30403,30500,31070,31407,31408,31409,31717,31736,31770,31840,31856,31858,31884,32152,32158,32227,32286,32370,32535,32640,33782);

UPDATE creature_template SET IconName='Gunner' WHERE entry IN (28319,28366,28833,30236,32629,33067,33167,33080,33139,33264,34111);
...
-- Quest 12996
UPDATE `creature_template` SET `spell1` = 54459,`spell2` = 54458,`spell3` = 54460,`VehicleId` = 208 WHERE `entry` = 29918;

-- from lanc
-- Quest: A Unified Front (13126)
UPDATE `creature_template` SET
    spell1 = 50232,
    spell2 = 50248,
    spell3 = 50240,
...
INSERT INTO `spell_script_target` VALUES (49460,1,27755),(49346,1,27692),(49464,1,27756);
REPLACE INTO creature_template_addon (entry,auras) VALUES (27755,57403),(27756,57403),(27692,57403);
...
INSERT INTO npc_spellclick_spells VALUES (27692,49346,0,0,0,1),(27755,49460,0,0,0,1),(27756,49464,0,0,0,1);

-- unifieddb fixes
DELETE FROM creature_addon WHERE guid IN (SELECT guid FROM creature WHERE id IN (33060,33062,33109,28768));
...
REPLACE INTO creature_template_addon (entry,mount) VALUES (28768,25445);
